...
The bundled `gesture_recognizer.task` is the official MediaPipe Gesture Recognizer float16 model. It is hosted on the same origin so recognition does not depend on Google network access at runtime.
